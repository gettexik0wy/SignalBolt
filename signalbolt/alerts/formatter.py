...
class SignalFormatter:
    ...
    def console(self, signal: Signal, colored: bool = True) -> str:
        ...
        lines = [
            ...
            f"  {CYAN}Timeframe:{RESET}  {signal.timeframe}",
            f"",
    ...
    def console_compact(self, signal: Signal) -> str:
        ...
        return (
            f"{emoji} [{time_str}] {signal.symbol} {signal.direction} [{signal.timeframe}] "
    ...
    def discord_embed(self, signal: Signal) -> dict:
        ...
        embed = {
            ...
            "fields": [
                ...
                {"name": "Regime", "value": signal.regime.upper(), "inline": False},
            ],
            "footer": {
